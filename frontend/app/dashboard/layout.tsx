...
const ROLE_NAV: Record<string, NavItem[]> = {
  ...
  manufacturer: [
    ...
    { href: '/dashboard/manufacturer/settings', label: 'Settings', icon: <Settings className="w-5 h-5" /> },
  ],
  corporate_admin: [
    ...
    { href: '/dashboard/corporate/payroll', label: 'Payroll', icon: <CreditCard className="w-5 h-5" /> },
    { href: '/dashboard/corporate/settings', label: 'Settings', icon: <Settings className="w-5 h-5" /> },
  ],
  superadmin: [
    { href: '/dashboard/admin', label: 'Overview', icon: <LayoutDashboard className="w-5 h-5" /> },
    { href: '/dashboard/admin/manufacturers', label: 'Manufacturers', icon: <Building2 className="w-5 h-5" /> },
    { href: '/dashboard/admin/routing', label: 'Routing Rules', icon: <TrendingUp className="w-5 h-5" /> },
    { href: '/dashboard/admin/legacy', label: 'Legacy & Claims', icon: <ShieldCheck className="w-5 h-5" /> },
    { href: '/dashboard/admin/users', label: 'Users', icon: <Users className="w-5 h-5" /> },
    { href: '/dashboard/admin/partners', label: 'Partners', icon: <Handshake className="w-5 h-5" /> },
